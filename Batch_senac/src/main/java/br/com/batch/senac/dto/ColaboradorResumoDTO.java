...
public class ColaboradorResumoDTO {
	...
	public String getCpfComplemento() {
		return cpfComplemento;
	}

	public void setCpfComplemento(String cpfComplemento) {
		this.cpfComplemento = cpfComplemento;
	}
	...
	public String getCodigoUnid() {
		return codigoUnid;
	}

	public void setCodigoUnid(String codigoUnid) {
